  ...
  return (
    <Page wide>
      <div className="flex items-center justify-between gap-3">
        <h1 className="text-[28px] font-semibold tracking-tight">{dashboard.greeting}</h1>
        <button
          type="button"
          className={btn.ghost}
          onClick={() => {
      ...
      {showCorrection && (
        <section role="status" className="mt-5 rounded-2xl border-2 border-neutral-950 bg-neutral-50 p-5">
      ...
      <div className="mt-6 grid gap-6 md:grid-cols-[1fr_260px]">
        <section aria-labelledby="plan-h">
          <h2 id="plan-h" className="mb-3 text-[17px] font-semibold">
            {dashboard.planTitle}
          </h2>
        ...
        <aside className="order-first md:order-none">
          <div className="rounded-2xl border-2 border-accent/40 p-5">
            ...
            {lastFromAdviser && (
              <Link to="/ask-adviser" className="mt-3 block rounded-xl bg-accent-tint p-3 text-[14px] text-neutral-900">
